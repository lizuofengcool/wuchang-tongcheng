...
- ✅ 后端单元测试（utils/setting/user 28 用例 + permission/category/region/news service 纯函数+业务逻辑 mock repo 用例 + file service Upload/List/Delete 主流程 + presign/sts 降级路径用例，覆盖无 DB/Redis 依赖）

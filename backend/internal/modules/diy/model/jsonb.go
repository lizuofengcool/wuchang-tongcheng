// Package model DIY 前端页面中台数据模型 - JSONB 字段类型
// 兼容 GORM 与 PostgreSQL jsonb 类型，参考 dh114 / marketing 模块实现
package model
...
func (j *JSONB) Scan(value interface{}) error {
	...
	return errors.New("diy.JSONB.Scan: unsupported source type")
}
...
func (j *JSONB) UnmarshalJSON(data []byte) error {
	if j == nil {
		return errors.New("diy.JSONB.UnmarshalJSON: nil pointer")
	}
	*j = append((*j)[:0], data...)
	return nil
}

// Package model love 相亲交友模块通用类型定义
// 提供 JSONB 字段类型，兼容 GORM 与 PostgreSQL jsonb 类型
...
func (j *JSONB) Scan(value interface{}) error {
	...
	return errors.New("love.JSONB.Scan: unsupported source type")
}
...
func (j *JSONB) UnmarshalJSON(data []byte) error {
	if j == nil {
		return errors.New("love.JSONB.UnmarshalJSON: nil pointer")
	}
	*j = append((*j)[:0], data...)
	return nil
}

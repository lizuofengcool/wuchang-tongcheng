...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_updated_at_column') THEN
        CREATE TRIGGER IF NOT EXISTS trg_pinches_updated_at BEFORE UPDATE ON pinches FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_routes_updated_at BEFORE UPDATE ON pinche_routes FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_bookings_updated_at BEFORE UPDATE ON pinche_bookings FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_drivers_updated_at BEFORE UPDATE ON pinche_drivers FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_vehicles_updated_at BEFORE UPDATE ON pinche_vehicles FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_insurances_updated_at BEFORE UPDATE ON pinche_insurances FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_payments_updated_at BEFORE UPDATE ON pinche_payments FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_ratings_updated_at BEFORE UPDATE ON pinche_ratings FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_emergencies_updated_at BEFORE UPDATE ON pinche_emergencies FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_trips_updated_at BEFORE UPDATE ON pinche_trips FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_route_favorites_updated_at BEFORE UPDATE ON pinche_route_favorites FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_messages_updated_at BEFORE UPDATE ON pinche_messages FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_cancels_updated_at BEFORE UPDATE ON pinche_cancels FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_refunds_updated_at BEFORE UPDATE ON pinche_refunds FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_complaints_updated_at BEFORE UPDATE ON pinche_complaints FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_audit_rules_updated_at BEFORE UPDATE ON pinche_audit_rules FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
        CREATE TRIGGER IF NOT EXISTS trg_pinche_statistics_updated_at BEFORE UPDATE ON pinche_statistics FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
    END IF;
END $$;
